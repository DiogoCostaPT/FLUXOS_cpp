...
resultdir_list = {
    ...'force_pond_1_new_with_IC/Results',...
    'force_pond_1_new_with_IC_flipped_rows_flowinputfixed_2/Results',...
    ...'force_pond_1_new_without_IC_flipped_rows_flowinputfixed_2/Results',...
    };
obsPath = '';
...
if CrossSections_outFiles_flag
    ...
    try
        res = importdata([FLUXOS_res_dir,'/',resultdir_list{i},'/cs/',outfilenam]);
